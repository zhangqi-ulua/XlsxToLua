...
namespace Assets.Scripts.CsClass
{
    public class TableDataTestAllDataTypePojo
    {
        ...
        public Dictionary<string, List<string>> TestDictIncludeArray { get; set; }
        ...
        public List<Dictionary<string, int>> TestArrayIncludeDict { get; set; }
        ...
        public int TestDate4 { get; set; }
        public DateTime TestTime1 { get; set; }
        public int TestTime2 { get; set; }
